...
public sealed class WeaponDefinition
{
    ...
    /// <summary>Tier is a stat swap on the same mesh — see GAMEPLAY_DESIGN.md.</summary>
    public int Tier;
...
/// <summary>
/// Stats live here rather than on <see cref="InvItem"/> so that saves store only ids.
...
public static class EquipmentCatalog
{
    ...
    private static readonly Dictionary<string, WeaponDefinition> Weapons = new();
    private static readonly Dictionary<string, ArmourDefinition> Armours = new();
    ...
    public static IEnumerable<WeaponDefinition> AllWeapons => Weapons.Values;
    public static IEnumerable<ArmourDefinition> AllArmours => Armours.Values;
}
