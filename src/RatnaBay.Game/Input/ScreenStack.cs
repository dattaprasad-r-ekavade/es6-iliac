...
internal sealed class ScreenStack
{
    ...
    public void OpenFort(WorldPanelInput panels)
    {
        Fort = true;
        Journal = false;
        Character = false;
        FortRoom = null;
        panels.FortSelection = 0;
    }
    ...
    public void OpenCharacter(WorldPanelInput panels)
    {
        Character = true;
        Journal = false;
        panels.InventorySelection = 0;
    }
