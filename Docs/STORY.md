...
Each new Deepankar arrives with **one line about who they were before the order**. That is the
whole feature.
...
> **A fallen Deepankar whose cache is never recovered eventually rises.**
...
> **Turn:** deep in the mountain, the first Deepankar. The order was founded to **stop** this, and
...
- Names for the province, the governor, and the first Deepankar.
